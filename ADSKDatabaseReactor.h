...
//-----------------------------------------------------------------------------
//----- ADSKDatabaseReactor.h : Declaration of the ADSKDatabaseReactor
//-----------------------------------------------------------------------------
#pragma once
...
/*!
        \brief При добавлении в базу данных нового экзампляра ADSKCustomPyramid
   добавляет к нему глобальный реактор - g_pPyramidReactor
*/
...
public:
  ...
  virtual void objectAppended(const AcDbDatabase *apDwg,
                              const AcDbObject *apDbObj) override;
};
