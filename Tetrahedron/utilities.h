...
/*!
	\brief Класс для идентификации grip точек, по переданному в конструкторе id. Используется в методе subGetGripPoints чтобы установить поле m_pAppData для класса AcDbGripData, чтобы в дальнейшем, в методе subMoveGripPointsAt получить id grip точки. 
*/
